...
class WP_Recipe_Maker {
	...
	private function define_constants() {
		define( 'WPRM_VERSION', '10.8.0' );
		define( 'WPRM_PREMIUM_VERSION_RECOMMENDED', '10.8.0' );
	...
	private function load_dependencies() {
		...
		require_once( WPRM_DIR . 'includes/public/class-wprm-placeholder.php' );
		...
		require_once( WPRM_DIR . 'includes/public/class-wprm-proxy.php' );
		...
		require_once( WPRM_DIR . 'includes/public/class-wprm-template-conditions.php' );
		require_once( WPRM_DIR . 'includes/public/class-wprm-template-editor.php' );
		require_once( WPRM_DIR . 'includes/public/class-wprm-template-fonts.php' );
